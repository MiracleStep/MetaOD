...
def prep_display(dets_out, img, h, w, undo_transform=True, class_color=False, mask_alpha=1.):
    """
...
def evalimage(net:Yolact, path:str, save_path:str=None):
    ...
    n = args.image.split("/")[-1].split(".")[0]
    save_path = "./result/Step1_extract_object/" + n + "/"
    # os.system("mkdir /s /q" + save_path)
    os.mkdir(save_path)
    n1 = args.image.split("/")[-1]
    save_path = "./result/Step1_extract_object/" + n + "/" + n1
